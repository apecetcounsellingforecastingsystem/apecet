...
def ingest_colleges_and_branches(conn):
    cursor = conn.cursor()
    excel_path = os.path.join(BASE_DIR, 'data', 'colleges_details.xlsx')
...
def ingest_cutoffs(conn):
    ...
    cutoff_files = [
        (2023, os.path.join('data', 'cutoffs', 'cutoffs_2023.xlsx'), 0),
        (2024, os.path.join('data', 'cutoffs', 'cutoffs_2024.xlsx'), 0),
        (2025, os.path.join('data', 'cutoffs', 'cutoffs_2025.xlsx'), 1),
        (2026, os.path.join('data', 'cutoffs', 'cutoffs_2026.xlsx'), 1),
    ]
